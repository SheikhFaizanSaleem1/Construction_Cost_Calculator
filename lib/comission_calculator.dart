...
class Comission_Calculator extends StatefulWidget {
  @override
  _Comission_CalculatorState createState() => _Comission_CalculatorState();
}

class _Comission_CalculatorState extends State<Comission_Calculator> {
